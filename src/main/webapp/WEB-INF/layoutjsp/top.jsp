...
<header id="header">
    <div class="container">
        <div class="row-fluid">
            <div class="logo">
                <a href="${pageContext.request.contextPath}/index"><img src="${pageContext.request.contextPath}/images/logo.png" alt="logo" /></a>
            </div>
        </div>
            ...
            <ul>
                ...
                <li class="last"><a>萌宠圈</a>
                    <ul style="display: none;">
                        ...
                        <li class="last"><a href="${pageContext.request.contextPath}/system_post">社区指南</a></li>
                    </ul>
                </li>
