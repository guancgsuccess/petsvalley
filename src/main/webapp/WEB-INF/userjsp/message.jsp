...
<head>
    ...
    <script>
        ...
        var url_getmessagelist ='${pageContext.request.contextPath}/message/getAllByPage';
        //页面加载后，首先加载所有的消息数据
       ...
       function loadMessages() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                for (var i = 0; i < objArr.length; i++) {
                    tbody.innerHTML += ('<tr><td>' + objArr[i].systemMessageId + '</td>' +
                        ...
                        '<td>' +strFormat(objArr[i].systemMessageTime) +'</td>' +
        ...
        function selectbydate() {
            ...
            var url_getmessagelistbydate ='${pageContext.request.contextPath}/message/getAllByPagedate/?from1='+from1+'&to='+to;
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="button" style="float: right" onclick="flushmescount()" class="btn btn-default" data-dismiss="modal">关闭</button>
                            </div>
                        </div>
                </div>
            </div>
