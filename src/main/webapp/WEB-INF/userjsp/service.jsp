...
<head>
    ...
    <script>
        ...
        var url_getservicelist ='${pageContext.request.contextPath}/service/getAllByPage';
        //页面加载后，首先加载所有的消息数据
       ...
       function loadServices() {
        ...
        function selectbydate() {
            ...
            var url_getservicelistbydate ='${pageContext.request.contextPath}/service/getAllByPagedate/?from1='+from1+'&to='+to;
