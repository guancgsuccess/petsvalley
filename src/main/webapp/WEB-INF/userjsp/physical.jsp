...
<head>
    ...
    <script>
        ...
        var url_getphysicallist ='${pageContext.request.contextPath}/physical/getAllByPage';
        //页面加载后，首先加载所有的消息数据
       ...
       function loadPhysicals() {
        ...
        function selectbydate() {
            ...
            var url_getphysicallistbydate ='${pageContext.request.contextPath}/physical/getAllByPagedate/?from1='+from1+'&to='+to;
