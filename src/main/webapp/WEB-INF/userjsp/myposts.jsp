...
<head>
    ...
    <script>
        ...
        var url_getmypostlist ='${pageContext.request.contextPath}/mypost/getAllByPage';
        //页面加载后，首先加载所有的消息数据
       ...
       function delforMypost(obr1){
           ...
           window.location="${pageContext.request.contextPath}/myposts";
            xhr.send();
        }
       function loadMyposts() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                for (var i = 0; i < objArr.length; i++) {
                    ...
                    tbody.innerHTML += ('<tr><td>' + objArr[i].postId + '</td>' +
        ...
        function selectbydate() {
            ...
            var url_getmypostlistbydate ='${pageContext.request.contextPath}/mypost/getAllByPagedate/?from1='+from1+'&to='+to;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <div class="form-group">
                           <table>
                               <tr>
                                   <td style="text-indent: 50px" id="myMypost"></td>
                               </tr>
                           </table>
                        </div>
                        <div class="form-group">
