...
<head>
    ...
    <script>
        ...
        var url_getvaccinelist ='${pageContext.request.contextPath}/vaccine/getAllByPage';
        //页面加载后，首先加载所有的消息数据
       ...
       function loadVaccines() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                for (var i = 0; i < objArr.length; i++) {
                    tbody.innerHTML += ('<tr><td>' + objArr[i].vaccId + '</td>' +
                        ...
                        '<td>' +strFormat(objArr[i].vaccTime) +'</td>' +
        ...
        function selectbydate() {
            ...
            var url_getvaccinelistbydate ='${pageContext.request.contextPath}/vaccine/getAllByPagedate/?from1='+from1+'&to='+to;
